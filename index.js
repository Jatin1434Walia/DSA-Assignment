...
// Solution:
var foundPair = (targetValue, arrayInput = [] ) => {
    var pairs = [];
...
const rotateString = (str1 = "", str2 = "") => {
  ...
  const str2 = "EDCBA";
  const str3 = "ABDCE";
  console.log(str1, str2, "is same", rotateString(str1, str2));
  console.log(str1, str3, "is same", rotateString(str1, str3));
